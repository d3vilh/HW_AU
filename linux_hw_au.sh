...
do ping -c1 -W1 $host 1> /dev/null && printf "$site_id |" && ssh -q $host "
	...
	printf \"\$hostik |\$ip_addr |\$routes |\$r_hw_type |\$r_hw_sn |\$score |\$our_kernel |\$hw_arch |\$app_version_date |\$up_version |\$orac_ver |\$orad_ver |\$tt_ver |\$wl_version |\$java_version |\$ram |\$c_cores |\$c_threads |\$core_enabled |\$cpu_m |\$hdd_size |\$hdd_model |\$hdd_heal |\$cur_fw_bank |\$cur_fw |\$max_files |\$file_limit |\$uptime |\$nic_drivers |\$emc |\$v7k |\$v5k |\$dd |\";";
	printf "\n";
done;
#Thats all folks!