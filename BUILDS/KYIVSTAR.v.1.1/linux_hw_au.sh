...
for host in $(grep -iE $delat_krasivo /etc/hosts|grep -viE '^ *#|audit_exclude|farm|blc|amm|esm|admin|zbx|hsbu|rctu|cross|old|emc|fcs|_upm|ilo|upm_|vip|nas_console|_hsbn|_sw'|awk {'print$2'}|sort|uniq);
